...
#DATA_FILE=${DATA_FILE:-/home/ubuntu/tsbsdata/mongo-data.gz}
DATA_FILE=${DATA_FILE:-/mnt/ramdisk/mongo-data.gz}
MONGO_URL=${MONGO_URL:-"mongodb+srv://mdbtest:test@tsbs.alsy8.mongodb-dev.net/admin"}
