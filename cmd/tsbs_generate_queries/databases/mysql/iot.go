...
// IoT produces MySQL-specific queries for all the iot query types.
type IoT struct {
	*iot.Core
	*BaseGenerator
}
...
func (i *IoT) LastLocByTruck(qi query.Query, nTrucks int) {
	...
	humanLabel := "MySQL last location by specific truck"
...
func (i *IoT) LastLocPerTruck(qi query.Query) {
	...
	humanLabel := "MySQL last location per truck"
...
func (i *IoT) TrucksWithLowFuel(qi query.Query) {
	...
	humanLabel := "MySQL trucks with low fuel"
...
func (i *IoT) TrucksWithHighLoad(qi query.Query) {
	...
	humanLabel := "MySQL trucks with high load"
...
func (i *IoT) StationaryTrucks(qi query.Query) {
	...
	humanLabel := "MySQL stationary trucks"
...
func (i *IoT) TrucksWithLongDrivingSessions(qi query.Query) {
	...
	humanLabel := "MySQL trucks with longer driving sessions"
...
func (i *IoT) TrucksWithLongDailySessions(qi query.Query) {
	...
	humanLabel := "MySQL trucks with longer daily sessions"
...
func (i *IoT) AvgVsProjectedFuelConsumption(qi query.Query) {
	...
	humanLabel := "MySQL average vs projected fuel consumption per fleet"
	humanDesc := humanLabel
...
func (i *IoT) AvgDailyDrivingDuration(qi query.Query) {
	...
	humanLabel := "MySQL average driver driving duration per day"
	humanDesc := humanLabel
...
func (i *IoT) AvgDailyDrivingSession(qi query.Query) {
	...
	humanLabel := "MySQL average driver driving session without stopping per day"
	humanDesc := humanLabel
...
func (i *IoT) AvgLoad(qi query.Query) {
	...
	humanLabel := "MySQL average load per truck model per fleet"
	humanDesc := humanLabel
...
func (i *IoT) DailyTruckActivity(qi query.Query) {
	...
	humanLabel := "MySQL daily truck activity per fleet per model"
	humanDesc := humanLabel
...
func (i *IoT) TruckBreakdownFrequency(qi query.Query) {
	...
	humanLabel := "MySQL truck breakdown frequency per model"
	humanDesc := humanLabel
