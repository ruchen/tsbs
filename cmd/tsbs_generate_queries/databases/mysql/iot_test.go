...
func TestLastLocByTruck(t *testing.T) {
	cases := []testCase{
		...
		},
		{
			...
			expectedHumanLabel: "MySQL last location by specific truck",
			expectedHumanDesc:  "MySQL last location by specific truck: random    1 trucks",
		...
		},
		{
			...
			expectedHumanLabel: "MySQL last location by specific truck",
			expectedHumanDesc:  "MySQL last location by specific truck: random    3 trucks",
			expectedHypertable: "readings",
			expectedSQLQuery: `SELECT t.name AS name, t.driver AS driver, r.*
		FROM tags t INNER JOIN LATERAL
			(SELECT longitude, latitude
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL last location per truck",
			expectedHumanDesc:  "MySQL last location per truck",
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL trucks with low fuel",
			expectedHumanDesc:  "MySQL trucks with low fuel: under 10 percent",
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL trucks with high load",
			expectedHumanDesc:  "MySQL trucks with high load: over 90 percent",
			expectedHypertable: iot.DiagnosticsTableName,
			expectedSQLQuery: `SELECT t.name AS name, t.driver AS driver, d.* 
		FROM tags t INNER JOIN LATERAL 
			(SELECT current_load 
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL stationary trucks",
			expectedHumanDesc:  "MySQL stationary trucks: with low avg velocity in last 10 minutes",
			expectedHypertable: iot.ReadingsTableName,
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL trucks with longer driving sessions",
			expectedHumanDesc:  "MySQL trucks with longer driving sessions: stopped less than 20 mins in 4 hour period",
			expectedHypertable: iot.ReadingsTableName,
			expectedSQLQuery: `SELECT t.name AS name, t.driver AS driver
		FROM tags t 
		INNER JOIN LATERAL 
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL trucks with longer daily sessions",
			expectedHumanDesc:  "MySQL trucks with longer daily sessions: drove more than 10 hours in the last 24 hours",
			expectedHypertable: iot.ReadingsTableName,
			expectedSQLQuery: `SELECT t.name AS name, t.driver AS driver
		FROM tags t 
		INNER JOIN LATERAL 
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL average vs projected fuel consumption per fleet",
			expectedHumanDesc:  "MySQL average vs projected fuel consumption per fleet",
			expectedHypertable: iot.ReadingsTableName,
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL average driver driving duration per day",
			expectedHumanDesc:  "MySQL average driver driving duration per day",
			expectedHypertable: iot.ReadingsTableName,
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL average driver driving session without stopping per day",
			expectedHumanDesc:  "MySQL average driver driving session without stopping per day",
			expectedHypertable: iot.ReadingsTableName,
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL average load per truck model per fleet",
			expectedHumanDesc:  "MySQL average load per truck model per fleet",
			expectedHypertable: iot.ReadingsTableName,
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL daily truck activity per fleet per model",
			expectedHumanDesc:  "MySQL daily truck activity per fleet per model",
			expectedHypertable: iot.ReadingsTableName,
	...
	cases := []testCase{
		{
			...
			expectedHumanLabel: "MySQL truck breakdown frequency per model",
			expectedHumanDesc:  "MySQL truck breakdown frequency per model",
			expectedHypertable: iot.DiagnosticsTableName,
